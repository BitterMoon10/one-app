...
import { WORK_FRAGMENTS } from '../../utils/workFragments';
    ...
    <>
      ...
      {explosion &&
        createPortal(
          ...
          {explosion.dimension.meteors.map((text, i) => {
            ...
            const fragments = WORK_FRAGMENTS[text];
            ...
            return (
              <div
                key={text}
                className={`fixed ${
                  fragments ? 'pointer-events-auto cursor-pointer' : 'pointer-events-none'
                }`}
                onClick={
                  fragments
                    ? (e) => {
                        ...
                        setBlackHole({
                          title: text,
                          accent: explosion.dimension.accent,
                        });
                      }
                    : undefined
                }
      ...
      {blackHole && (
        <BlackHole
          ...
          fragments={WORK_FRAGMENTS[blackHole.title]}
          accent={blackHole.accent}
