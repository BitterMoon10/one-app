...
const categories: Category[] = [
  {
    ...
    photos: [
      { id: 'p1', image: '/one-app/photo-landscape.jpg', title: '雾中孤舟', size: 'large' },
      { id: 'p2', image: '/one-app/photo-mountain.jpg', title: '山湖倒影', size: 'medium' },
      { id: 'p3', image: '/one-app/photo-1.jpg', title: '金色麦田', size: 'small' },
      { id: 'p4', image: '/one-app/photo-2.jpg', title: '雪后森林', size: 'medium' },
      { id: 'p5', image: '/one-app/photo-3.jpg', title: '海边灯塔', size: 'small' },
      { id: 'p6', image: '/one-app/photo-7.jpg', title: '冰岛极光', size: 'large' },
    ],
  },
  {
    id: '2',
    ...
    photos: [
      { id: 'p7', image: '/one-app/photo-4.jpg', title: '樱花古刹', size: 'medium' },
      { id: 'p8', image: '/one-app/photo-5.jpg', title: '沙漠驼队', size: 'large' },
      { id: 'p9', image: '/one-app/photo-6.jpg', title: '威尼斯晨雾', size: 'small' },
      { id: 'p10', image: '/one-app/photo-8.jpg', title: '巴黎铁塔', size: 'medium' },
      { id: 'p11', image: '/one-app/photo-9.jpg', title: '桂林山水', size: 'large' },
      { id: 'p12', image: '/one-app/photo-12.jpg', title: '泰姬陵日出', size: 'small' },
    ],
  },
  {
    id: '3',
    ...
    photos: [
      { id: 'p13', image: '/one-app/photo-street.jpg', title: '雨夜霓虹', size: 'large' },
      { id: 'p14', image: '/one-app/photo-10.jpg', title: '非洲草原', size: 'medium' },
      { id: 'p15', image: '/one-app/photo-11.jpg', title: '曼哈顿黄昏', size: 'large' },
      { id: 'p16', image: '/one-app/hero-bg.jpg', title: '静谧湖面', size: 'small' },
      { id: 'p17', image: '/one-app/photo-portrait.jpg', title: '午后阳光', size: 'medium' },
    ],
  },
];
